...
rMATS_bam <- addMeta(
    rMATS_bam,
    label = "rMATS_bam",
    doc = "Tool to detect differential alternative splicing events from RNA-Seq data. with bam as input",
    inputLabels = c("bam1","bam2","type","readLength","gtf","threads","tstat","tmp","libType","varReadLength","anchorLength","cstat","task","statoff","pairedStats","novelSS","mil","mel","fixedEvent","darts"),
