...
annovar <- addMeta(
    annovar,
    label = "annovar",
    doc = "ANNOVAR is an efficient software tool to utilize update-to-date information to functionally annotate genetic variants detected from diverse genomes",
    inputLabels = c("vcf","db","build","aout","protocol","operation","nastring"),
    inputDocs = c("Query vcf File for the annovar tool to annotate","location of the database used to annotate the file","genome build version (default: hg18)","output file name prefix","comma-delimited string specifying database protocol","comma-delimited string specifying type of operation","string to display when a score is not available (default: null)"),
    outputLabels = c("Aout"),
    outputDocs = c("The annotated file generated by annovar"),
    extensions = list(
